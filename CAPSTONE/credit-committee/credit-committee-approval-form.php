<?php
    ...
    elseif (isset($_POST['submit-btn']))
    {
        ...
        $credit_loan_type = $_POST['credit-loan-type'];
        $credit_loan_amount = $_POST['credit-loan-amount'];
        $credit_loan_terms = $_POST['credit-loan-term'];
        $credit_remarks = $_POST['credit-remarks'];
        $credit_approval_status = $_POST['credit-approval-selection'];

        $sql = "INSERT INTO creditcomm_approvals (application_id, account_id,creditcomm_loanType,creditcomm_loanAmount,creditcomm_loanTerm,creditcomm_remarks, creditcomm_approvalStatus)
        VALUES ($applicationID, '$accountID', '$credit_loan_type', '$credit_loan_amount', '$credit_loan_terms', '$credit_remarks', '$credit_approval_status')";

        

        $result = $conn->query($sql);

        if ($credit_approval_status === "Approved" ||  $credit_approval_status === "Approved with Modification")
        {  
            $sql3 = "UPDATE financial_db
            SET application_status = 'For BOD Evaluation' WHERE application_id = $applicationID";
            ...
            if ($result && $result2 && $result4)
            {
                echo "<script>
                        ...
                        window.location.href= 'credit-committee-loan-requests.php';
                    </script>";
            }
            else
            {
        ...
        else if ($credit_approval_status === "Disapproved")
        {
...
<head>
    ...
    <title>HFSCCO | Credit Committee Loan Approval Form</title>
...
<body>
            ...
            <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <div class = "p-3" id = "approval-form">
                    <div class = "header mt-2">
                        <img src="../Resources/logo.png" alt="Logo" style="width: 50px; height: 50px;">
                        <h1 class="modal-title fs-3" id="exampleModalLabel">&nbsp;&nbsp;Loan Application Approval Form - Credit Committee Personnel</h1>
                    </div>
                    ...
                    <div class = "approval-section row mt-5">
                        <div class = "row col-12 mt-3">
                            <h4>For Approval</h4><small>(by Credit Committee Officer)</small>
                        </div>
                        <div class="row mt-5 mb-3" id="account-details">
                            <div class = "col-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="col-12 col-md-6 col-lg-9 mb-3">
                                    <label class="form-label">Loan Type:</label>
                                    <select class="form-select border border-dark-subtle" name="credit-loan-type">
                                        <option value=""></option>
                                        <option name="credit-loan-type" value="(VL)Vendors Loan">(VL)Vendor's Loan</option>
                                        <option name="credit-loan-type" value="(MEL)Micro Enterprise Loan">(MEL)Micro Enterprise Loan</option>
                                        <option name="credit-loan-type" value="(SEL)Small Enterprise Loan">(SEL)Small Enterprise Loan</option>
                                        <option name="credit-loan-type" value="(BL)Business Loan">(BL)Business Loan</option>
                                        <option name="credit-loan-type" value="(CL)Commercial Loan">(CL)Commercial Loan</option>
                                        <option name="credit-loan-type" value="(IL)Infrastructure Loan">(IL)Infrastructure Loan</option>
                                        <option name="credit-loan-type" value="(CRL-PROD)Check Rediscounting (Productive)">(CRL-PROD)Check Rediscounting (Productive)</option>
                                        <option name="credit-loan-type" value="(LAD-PROD)Loan Against Deposit (Productive)">(LAD-PROD)Loan Against Deposit (Productive)</option>
                                        <option name="credit-loan-type" value="(FLL-PROD)Fast Lane Loan (Productive)">(FLL-PROD)Fast Lane Loan (Productive)</option>
                                        <option name="credit-loan-type" value="(CRL-PROV)Check Rediscounting (Providential)">(CRL-PROV)Check Rediscounting (Providential)</option>
                                        <option name="credit-loan-type" value="(LAD-PROV)Loan Against Deposit (Providential)">(LAD-PROV)Loan Against Deposit (Providential)</option>
                                        <option name="credit-loan-type" value="(FLL-PROV)Fast Lane Loan (Providential)">(FLL-PROV)Fast Lane Loan (Providential)</option>
                                        <option name="credit-loan-type" value="(EL)Educational Loan">(EL)Educational Loan</option>
                                        <option name="credit-loan-type" value="(INVL)Investment Loan">(INVL)Investment Loan</option>
                                        <option name="credit-loan-type" value="(MAL)Medical Assistance Loan">(MAL)Medical Assistance Loan</option>
                                        <option name="credit-loan-type" value="(PL)Personal Loan">(PL)Personal Loan</option>
                                        <option name="credit-loan-type" value="(TL)Travel Loan">(TL)Travel Loan</option>
                                        <option name="credit-loan-type" value="(UTL)Utilities Assistance Loan">(UTL)Utilities Assistance Loan</option>
                                        <option name="credit-loan-type" value="(LEL)Life Events Loan">(LEL)Life Events Loan</option>
                                        <option name="credit-loan-type" value="(GAFL)Gadget-Appliance-Furniture Loan">(GAFL)Gadget-Appliance-Furniture Loan</option>
                                        <option name="credit-loan-type" value="(EML)Emergency Loan">(EML)Emergency Loan</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-6 col-lg-9 mb-2">
                                    <label class="form-label">Loan Amount:</label>
                                    <input type="text" class="form-control border border-dark-subtle" name = "credit-loan-amount" required>
                                </div>
                                <div class="col-12 col-md-6 col-lg-9 mb-2">
                                    <label class="form-label">Loan Term:</label>
                                    <input type="text" class="form-control border border-dark-subtle" name = "credit-loan-term">
                                </div>
                            </div>

                            <div class = "col-12 col-sm-6 col-md-6 col-lg-4">
                                <label class="form-label">Remarks:</label>
                                <textarea class="form-control border border-dark-subtle" placeholder="" name = "credit-remarks" required id="floatingTextarea" rows="6" style="resize: none;"></textarea>
                            </div>
    ...
    <script>
        ...
        // JavaScript code to redirect when cancel button is clicked
        document.getElementsByName('cancel-btn')[0].addEventListener('click', function(event) {
            event.preventDefault(); // Prevent form submission
            window.location.href = 'bod-loanRequests.php'; // Redirect to bod_loan_requests.php
        });
    </script>
