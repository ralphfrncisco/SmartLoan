            ...
            <div class="row g-2 mt-2" id = "total-data">
                <div class="col-6 col-md-4">
                    <div id="registered-total">
                        <div>
                            <?php
                                $sql = "SELECT COUNT(*) AS regd_loan_apps FROM financial_db WHERE application_status != 'For Releasing' AND application_status != 'Declined'";
                ...
                <div class="col-6 col-md-4">
                    <div class="" id="pending-member-total">
                        <div class="">
                            <?php
                                $sql = "SELECT COUNT(*) AS pending_mem_apps FROM members_db WHERE acc_status = 'Pending'";
                                $result = $conn->query($sql);
