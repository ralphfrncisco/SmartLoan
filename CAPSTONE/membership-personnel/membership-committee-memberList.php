...
<body>
    ...
    <div id="page-content" class="content">
                    ...
                    <ul class="nav flex-column" style="width: 100%; max-width: 200px; margin-left: 5%;">
                        ...
                        <li class="nav-item" style="margin-left: 2px;">
                            <a class="nav-link" href="membership-upload-records.php">
                                ...
                                <span id = "nav-text">Import Account</span>
                            </a>
                        </li>
                        <li class="nav-item" style="margin-left: 2px;">
                            <a class="nav-link" href="membership-committee-setPassword.php">
                ...
                <table class="table" id="members-loan-history-table">
                    <thead id="history-header" style="background-color: #e0e0e0;">
                        <tr class="align-bottom">
                            <th id="td-loanType" style="text-align: center; width: 7%; padding-left: 1%;">Account ID</th>
                            ...
                            <th id="td-Amount" style="width: 18%; text-align: center;">Status</th>
                            <th id="td-Status" style="width: 10%;">Status</th>
                            <th id="td-Status" style="width: 10%;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        else
                        {
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                echo "<td style = 'text-align: center; color: green;'>" . $row['acc_status']. "</td>";
                                echo "<td style = 'text-align: center;'> 
                                <a class = 'edit-btn' href='membership-committee-MSA.php?account_id=$row[account_id]'><i class='bx bx-show'></i></a>
                                <a class = 'edit-btn' href='print.php?account_id=$row[account_id]'><i class='bx bx-printer' style='color:#ffffff' ></i></a>
                                </td>";
                                echo "</tr>";
                            }
                        }
     ...
     <style>
        ...
        .edit-btn .bx-show,.edit-btn .bx-printer
        {
            font-size: 20px;
        }
        .edit-btn:hover
