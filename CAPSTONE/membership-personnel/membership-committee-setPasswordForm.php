<?php
    ...
    else
    {
      ...
      SET password = '$encrypted_pw',
        ...
        acc_status = 'Active'
        WHERE application_num = $application_id AND account_id = '$account_id'";

      $sql2 = "INSERT into members_acc(account_id, Email, password, access_type) VALUES('$account_id', '$email_address', '$encrypted_pw', 'member')";
      
      $timestamp = date("Y-m-d H:i:s");
      $sql3 = "INSERT INTO audit_logs(action, actor, timestamp) VALUES('Update the account details of member $account_id', 'Membership Pesonnel', '$timestamp')";
      ...
      {
        echo "<script>alert('An error occurred'); window.location.href='membership-committee-setPassword.php'</script>";
      }
      else
      {
        echo "<script>alert('Record was updated successfully!');
        window.location.href='membership-committee-setPassword.php';
        </script>";
        exit;
      }
    }
          ...
          <div class = "row mt-4" id = "approval-form">
              ...
              <div class = "row mb-5">
                <div class = "col-12 col-lg-4">
                    ...
                    <div class="mt-3 mb-2" style = "width: 245px;">
                        ...
                        <input type="text" name="AccountID" inputmode="numeric" class="form-control border border-dark-subtle" value = "<?php echo $account_id?>" aria-label="Account_Num">
                    </div>
                </div>
                <div class = "col-12 col-lg-4" id = "set-PasswordDiv">
                    <h5><b>Set Password&nbsp;</b><span id = "required">*</span></h5>
                    <div class="mt-3 mb-2" style = "width: 245px;">
                        <input type = "text" name = "Password" class = "form-control border border-dark-subtle" required>
                    </div>
                </div>
            ...
            <div class = "form-controls-section col col-12 col-md-3" style = "padding-left: 2%;">
              <div class = "row mt-5 d-flex justify-content-center">
                <input type = "submit" id = "submitBtn" name = "submit-btn" value = "Update">
                <a href = "membership-committee-setPassword.php" id = "cancelBtn" class = "btn btn-secondary mt-3" style = "height: 40px;">Cancel</a>
              </div>
            </div>
          </div>
