                ...
                <table class="table" id="members-loan-history-table">
                    <thead id="history-header" style="background-color: #e0e0e0;">
                        <tr class="align-bottom">
                            <th id="td-loanType" style="text-align: left; width: 15%; padding-left: 1.3%;">Promissory Note Number</th>
                            ...
                            <th id="td-invoice" style="width: 14%; text-align: center;">Loan Amount</th>
                            <th id="td-Amount" style="width: 18%; text-align: center;">Date Applied</th>
                    ...
                    <tbody>
                        <?php
                            $sql = "SELECT financial_db.application_id, financial_db.LastName, financial_db.FirstName, financial_db.loan_Amount, 
                                        financial_db.date_applied, financial_db.type_of_application, financial_db.application_status 
                                    FROM financial_db 
                                    LEFT JOIN bod_approvals 
                                    ON financial_db.application_id = bod_approvals.application_id AND bod_approvals.bod_acc_id = '$account_id'
                                    WHERE financial_db.application_status = 'For BOD Evaluation' 
                                    AND bod_approvals.application_id IS NULL";
                            ...
                            if (isset($_POST['search-btn'])) {
                                ...
                                $sql = "SELECT financial_db.application_id, financial_db.LastName, financial_db.FirstName, financial_db.loan_Amount, 
                                        ...
                                        WHERE financial_db.application_status = 'For BOD Evaluation' 
                                        AND bod_approvals.application_id IS NULL
                                        AND (financial_db.application_id LIKE '%$search%' 
                                            OR financial_db.LastName LIKE '%$search%' 
                                            OR financial_db.FirstName LIKE '%$search%' 
                                            OR financial_db.loan_Amount LIKE '%$search%' 
                                            OR financial_db.date_applied LIKE '%$search%' 
                                            OR financial_db.application_status LIKE '%$search%')";
                            }
                            ...
                            echo"</tr>";
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td style='text-align: center;'> <span id='peso-sign-table'>₱ </span>" . $row['loan_Amount'] . "</td>";
                                    echo "<td style='text-align: center;'>" . $row['date_applied'] . "</td>";
                                    echo "<td style='text-align: center;'>" . $row['application_status'] . "</td>";
                                    echo "<td style='text-align: center;'> <a href='bod_approval-page.php?application_id=" . $row['application_id'] . "' class='edit-btn'><i class='bx bxs-edit'></i></a></td>";
                                    echo "</tr>";
                                }
                            }
                        ?>
