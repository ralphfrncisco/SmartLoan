<?php
    ...
    if (isset($_POST["save_changes"])) {
        ...
        foreach ($uniqueRefs as $index => $uniqueRef) {
            ...
            $query = "
                UPDATE INTO loan_balance (unique_ref, code, member_name, loan, granted, balance, interest)
                VALUES ('$uniqueRef', '$Code', '$MemberName', '$Loan', '$Granted', '$Balance', '$Interest')
...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="bi bi-database-fill-up"></i>
                    <span style = "margin-top: 5px;">Update Records</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div id="page-content" class="content">
        <nav class="navbar navbar-expand-lg" id = "side-navbar">
            ...
            <span class="navbar-brand mb-0 h1 text-white">Update Records</span>
                    ...
                    <ul class="nav flex-column" style="width: 100%; max-width: 200px; margin-left: 5%;">
                        ...
                        <li class="nav-item" style="margin-left: 2px;">
                            <a class="nav-link" href="loan-personnel-laf-approved.php">
                                ...
                                <span id = "nav-text" >Approved Loans</span>
                            </a>
                        </li>
                        <li class="nav-item" style="margin-left: 2px;">
                            <a class="nav-link" href="#">
                        ...
                        <li class="nav-item" style="margin-left: 2px;">
                            <a class="nav-link" href="#">
                                ...
                                <span id = "nav-text" >Update Records</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="loan-personnel-memberList.php">
