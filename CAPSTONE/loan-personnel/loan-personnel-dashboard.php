            ...
            <div class="row g-2 mt-2" id = "total-data">
                <div class="col-6 col-md-4">
                    <div id="registered-total">
                        <div>
                            <?php
                                $sql = "SELECT COUNT(*) AS regd_loan_apps FROM financial_db WHERE application_status != 'For Releasing' AND application_status != 'Declined' AND application_status != 'Received'";
