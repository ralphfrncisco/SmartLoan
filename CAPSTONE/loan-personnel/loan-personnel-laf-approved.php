                ...
                <table class="table" id="members-loan-history-table">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows == 0) {
                            ...
                            echo "<td colspan = 8 style = 'text-align:center; background-color: gray;'><b><p style = 'font-size: 25px; margin-top: 8%; color: black;'>No Pending Loan Request at the moment :P</p></b></td>";
                            echo"</tr>";
                        }
                        else
                        {
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                echo "<td style = 'text-align: center;'> <a class = 'text-secondary-emphasis' href='loan-personnel_loanDetailedView.php?application_id=$row[application_id]'>Details</a></td>";
                                echo "</tr>";
                            }
                        }
                    ?>
