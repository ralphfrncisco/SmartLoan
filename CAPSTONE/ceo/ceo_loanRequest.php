        ...
        <div class="container-xxl mb-5">
            <div class = "table-responsive">
                <table class="table" id="members-loan-history-table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM financial_db WHERE application_status = 'For CEO Evaluation'";
                        ...
                        else
                        {
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                echo "<td style = 'text-align: center;'> <a href='ceo_approval-page.php?application_id=$row[application_id]' class = 'edit-btn'><i class='bx bxs-edit'></i></a></td>";
                                echo "</tr>";
                            }
                        }
                    ?>
